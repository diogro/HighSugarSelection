...
Here, we track the allele frequency trajectory of several million SNPs in replicate populations of _D. melanogaster_ exposed to a new and stressful environment in the form a high sugar diet. Using a straightforward comparison between the allele frequency time series between control and selected populations, we are able to detect a large number of SNPs whose allele frequency changes in a consistent fashion in the selected populations and not in the control population, which suggest that the exposure to high sugar is driving this consistent response. Indeed, the correlation across allele frequency change is enough to cluster control and selected populations using a PCA. Surprisingly, the lab environment, shared between control and selected populations, appears to be a stronger source of selection than the exposure to high sugar. The subtle changes in allele frequency and the extremely large number of SNPs that show signatures of selection are suggestive of a massively polygenic selection response. This polygenic response appears to be grounded in regulatory changes, and we show that differentially expressed genes in the populations exposed to high sugar are enriched for SNPs under selection. We also look for signatures of interactions between selected loci, and find strong evidence for epistasis for fitness, in the form of gametic disequilibrium between you physically unlinked loci and correlations between allele frequency trajectory of these same loci. 

Highgly polygenic genetic architectures have had a recent renascaice in the literature of complex traits [@Rockman2012-lz; @Boyle2017-re]. Progressively more powerful genome wise association studies [], evidence from E&R experiment [] and gene interaction networks [] have revealed a rich set of loci and genes implicated in determining the phetypic variation of quantitative traits. Our results largely confirm this trent, and our uniquely powerfull design uncovers signatures of selection spannig a significant fraction of the genome. This widespread response is undoubtouble related to the strong stress caused by the high sugar diet, as we expect several phenotypes at different leves of organization to be involved in the response to selection.

While we do not have acess to the phenotypes under selection, we are able to probe these putative differences by analysing differential gene expression. Selected lines show hundreds of DE genes, and these are indeed enriched for selected SNPs, suggestive of a link between eQTL variation and the response to selection. GO enrichment in these differentially expressed genes identifies several terms associated with metabolism and behaviour, consistente with their involvement the response to selection.
