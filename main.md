...
Identifying the signatures of polygenic and epistatic response to selection is a challenging problem, and Evolve and Resequence (E&R) experiments have emerged as a natural and powerful tool for investigating these questions [@Barghi2020-ie]. By exposing populations to a stressful treatment condition and keeping them in this environment for several generations we are able to track the resulting changes in genetic composition due to selection. By tracking allele frequencies though time in both selected and control populations, we can distinguish the effects related to adaptation to laboratory conditions and the effects due to the selective stress imposed on the treatment populations. The exposure to environmental stress also opens the possibility for new gene combinations to be selected on [@Ogbunugafor2022-tl; @Das2020-xp], allowing us to search for the signatures of selection on epistatic combinations that are revealed by the new environment. 
